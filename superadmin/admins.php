...
$admins = $conn->query("SELECT * FROM admin_222060");
...
if (isset($_POST['add_admin'])) {
    ...
    $query = "INSERT INTO admin_222060 (username_222060, email_222060, password_222060) VALUES ('$username', '$email', '$password')";
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $conn->query("DELETE FROM admin_222060 WHERE id_222060=$id");
    header("Location: admins.php");
    exit();
}
...
<aside class="sidebar" id="sidebar">
    ...
    <ul>
        ...
        <li><a href="admins.php" class="<?= $current_page == 'admins.php' ? 'active' : '' ?>">
            <i class="bi bi-person-badge"></i> Kelola Admin
        </a></li>
...
<main class="content">
    <div class="card-section">
        <h2><i class="bi bi-person-plus-fill"></i> Tambah Admin Baru</h2>
    ...
    <div class="card-section">
        <h2><i class="bi bi-people-fill"></i> Daftar Admin</h2>
        ...
        <!-- Admin Cards View -->
        <div class="admin-cards" id="adminCardsContainer">
            <?php 
            $no = 1;
            while ($row = $admins->fetch_assoc()) { ?>
                <div class="admin-card">
                    ...
                    <div class="card-actions">
                        <a href="admins.php?delete=<?= $row['id_222060'] ?>" class="btn btn-danger" onclick="return confirm('Hapus admin ini?')">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("cardView").addEventListener("click", function() {
            document.getElementById("adminCardsContainer").style.display = "grid";
        ...
        document.getElementById("tableView").addEventListener("click", function() {
            document.getElementById("adminCardsContainer").style.display = "none";
